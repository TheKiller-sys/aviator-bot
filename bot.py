...
MENSAJES_BIENVENIDA = {
    1: "¡Hola Juan! 🚀 ¡Listo para un día de ventas exitosas? ¡Vamos a superar esos objetivos!",
    2: "¡Hola María! 👋 ¡A brillar hoy! ¡Cada venta te acerca a tus sueños!",
    3: "¡Hola Quiosco!\n\n Aqui podras anotar todas tus ventas y llevar mejor control",
}
...
def cmd_start(message):
    ...
    if vendedor_id_sesion:
        vendedor = next((v for v in USUARIOS_INICIALES if v[0] == f"vendedor{vendedor_id_sesion}"), None)
        if vendedor:
    ...
    mensaje_bienvenida = "¡Bienvenido a ServiceJ Bot! 👋 Aquí puedes registrar tus ventas diarias. " \
